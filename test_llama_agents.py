...
control_plane = ControlPlaneServer(
    ...
    orchestrator=AgentOrchestrator(llm=Cohere()),
)
...
# create our agents
worker1 = FunctionCallingAgentWorker.from_tools([tool], llm=Cohere())
worker2 = FunctionCallingAgentWorker.from_tools([], llm=Cohere())
